...
class data_collect:
	...
	def setup_parameters(self):
		...
		# For Multi-Robot System Development (Dynamic Data Array)
		self.img_array = []
		self.odom_array = []
	...
	def save_data(self, img):
		...
		self.odom_array.append(self.current_odom.pose.pose)
		self.last_odom = self.current_odom
		print("Image Array Length: %d" % len(self.img_array))
		print("Odom Array Length: %d" % len(self.odom_array))
		print(self.odom_array)
