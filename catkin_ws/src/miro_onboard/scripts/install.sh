...
ssh -t "miro@$ip" "cd ~/.miro2/config && echo 'source ~/mdk/catkin_ws/devel/setup.bash && roslaunch miro_onboard onboard.launch &' > on_system_ready.sh && chmod +x on_system_ready.sh"